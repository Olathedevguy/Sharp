...
const AdminAuthPage = ({ isAdminLoginSuccessful, handleAdminSuccess }) => {
    ...
    return (
        <div  className='flex items-center bg-custom-image3 justify-center h-screen w-screen'> 
            ...
            <button className={isLoading ? 'flex items-center justify-center bg-[#000000] -py-1 rounded-md outline-none' : 'flex items-center justify-center  rounded-md bg-[#000000] w-[400px] text-[#ffffff] py-[17px] outline-none'}
