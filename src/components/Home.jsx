    ...
    <div className=''>
      <div className={`bg-custom-image bg-cover bg-center h-[105vh] w-full`}>
        <div className='pt-[400px] pl-20'>
           <h1 className=' text-xl text-[#1E1E1E] mb-3'><span className='font-semibold text-[50px]'>JUST DO IT,</span> the way you like</h1>
          <p className='text-xl text-[#1E1E1E] w-[450px]'>
          explore, what you want, how you want,
          and when you want; from tech gears to
          sports gears, shoes and more.</p>
